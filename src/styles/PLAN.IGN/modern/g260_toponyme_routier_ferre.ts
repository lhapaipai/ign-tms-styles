...
export const g260_toponyme_routier_ferre: LayerGroupFactory = (vars) => {
  const { cHydro, toponymeHalo, cToponyme, toponymeRoutierHalo, autoroute, routePrincipale, routeRegionale } = vars;
